...
//        if($v_res['code'] ==0) return ['code'=>0,'msg'=>$v_res['msg'],'url'=>'','data'=>''];
    ...
    private function beforeCart($adress)
    {
        ...
        if (0 == $this->cartLogic->cartCount($this->user_id, 1)) {
    ...
    public function cart3()
    {
        ...
        if ($this->cartLogic->cartCount($this->user_id, 1) < 1) {
...
//        $result['data']['order_amount'] = 0;
        ...
        // 提交订单
        if ($this->request->isPost() && ('submit_order' == $this->request->param('act'))) {
